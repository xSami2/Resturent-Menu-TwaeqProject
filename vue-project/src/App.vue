...
function ConfirmOrder(){
  Swal.fire({
    icon: 'success',
    title: 'شكرا لك',
    text: 'سيتم توصيل طلبك خلال 30-40 دقيقة عمل',
...
<div class="row p-1 text-center">
 ...
 />
  ...
  <footer class="text-center text-white mt-4" style="background-color: #f1f1f1;">
    <!-- Grid container -->
    ...
    <div class="text-center text-dark p-1 " style="background-color: rgba(0, 0, 0, 0.2);">
      <p class="mt-2"> سلسلة مطاعم مير السعودية</p>
    </div>
